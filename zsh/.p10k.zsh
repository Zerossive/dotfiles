# Generated by Powerlevel10k configuration wizard on 2024-04-17 at 12:41 CDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VICMD_CONTENT_EXPANSION='🞛 ' # default: ❮
  # Prompt symbol in visual vi mode.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIVIS_CONTENT_EXPANSION='⯁ ' # default: V
  ...
  # option to define custom colors and icons for different directory classes.
    ...
    typeset -g POWERLEVEL9K_DIR_ELYSIUM_VISUAL_IDENTIFIER_EXPANSION='🏛 '
    typeset -g POWERLEVEL9K_DIR_NEOVIM_VISUAL_IDENTIFIER_EXPANSION=' '
    typeset -g POWERLEVEL9K_DIR_CONFIG_VISUAL_IDENTIFIER_EXPANSION=' '
    typeset -g POWERLEVEL9K_DIR_ABSOLUTEHOME_VISUAL_IDENTIFIER_EXPANSION=' '
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local   modified='%5F'  # blue foreground
  ...
  typeset -g POWERLEVEL9K_IP_CONTENT_EXPANSION='$P9K_IP_IP${P9K_IP_RX_RATE:+ %10F⇣$P9K_IP_RX_RATE}${P9K_IP_TX_RATE:+ %215F⇡$P9K_IP_TX_RATE}'
